...
@property (nonatomic,strong) NSImageView *scanImageView;
...
- (NSImageView *)scanImageView{
    if (!_scanImageView) {
        _scanImageView = [[NSImageView alloc] init];
    }
...
//    [NSView animateWithDuration:1.4 animations:^{
//        weakSelf.alpha = 1.0;
//        
