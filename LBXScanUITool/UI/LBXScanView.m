...
//线条在中间位置，不移动
@property (nonatomic,strong,nullable)NSImageView *scanLineStill;
        ...
        case LBXScanViewAnimationStyle_LineStill:
        {
            if (!_scanLineStill) {
                ...
                CGRect stillRect = CGRectMake(_scanRetangleRect.origin.x+20,
                                              ...
                                              2);
                _scanLineStill = [[NSImageView alloc]initWithFrame:stillRect];
...
//    NSLog(@"frame:%d",NSStringFromCGRect(self.frame));
...
//    [NSBezierPath fillRect:rect1];
    ...
    //绘制矩形
    NSRect rect = CGRectMake(XRetangleLeft, YMinRetangle, sizeRetangle.width, sizeRetangle.height);
    [_viewStyle.colorRetangleLine setStroke];
